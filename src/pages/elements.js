...
const ElementsPage = ({ data }, location) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <article className="post-content page-template no-image">
        ...
        <p>This is <strong><strong>bold</strong></strong> and this is <strong><strong>strong</strong></strong>. This is <em><em>italic</em></em> and this is <em><em>emphasized</em></em>. This is <sup>superscript</sup>text and this is <sub>subscript</sub> text. This is <u>underlined</u> and this is code: <code>for (;;) {'{'} ... {'}'}</code>. Finally, this is a <a href="#">link</a>.</p>
  ...
  <h3 id="unordered"><strong><strong>Unordered</strong></strong></h3>
  <ul>
  ...
  <hr />
  <h2 id="blockquote"><strong>Blockquote</strong></h2>
  ...
  <figure className="kg-card kg-image-card kg-width-wide">
    <Img fluid={data.medPic.childImageSharp.fluid} className="kg-image" />
    <figcaption>Large image</figcaption>
  </figure>
  <figure className="kg-card kg-image-card kg-width-full">
    <Img fluid={data.largePic.childImageSharp.fluid} className="kg-image" />
  ...
  <div className="row">
    <div className="col-12">
      <div style={{padding: '1rem 0', textAlign: 'center', background: '#eee'}}>12</div>
    </div>
  </div>
  <div className="row">
    <div className="col-3">
      <div style={{padding: '1rem 0', textAlign: 'center', background: '#eee'}}>3</div>
    </div>
    <div className="col-9">
      <div style={{padding: '1rem 0', textAlign: 'center', background: '#eee'}}>9</div>
    </div>
  </div>
  <div className="row">
    <div className="col-6">
      <div style={{padding: '1rem 0', textAlign: 'center', background: '#eee'}}>6</div>
    </div>
    <div className="col-6">
      <div style={{padding: '1rem 0', textAlign: 'center', background: '#eee'}}>6</div>
    </div>
  ...
  <div className="row">
    <div className="col">
      <div style={{padding: '1rem 0', textAlign: 'center', background: '#eee'}}>auto</div>
    </div>
    <div className="col">
      <div style={{padding: '1rem 0', textAlign: 'center', background: '#eee'}}>auto</div>
    </div>
